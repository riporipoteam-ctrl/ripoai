...
export default function ChatView() {
  ...
  return (
    <div className="chat-shell flex h-full flex-col">
        ...
        {empty ? (
          <div className="empty-state flex min-h-full flex-col items-center justify-center px-3 py-5 sm:px-4 sm:py-8">
            <motion.section
              ...
              className="hero-card glass relative w-full max-w-3xl overflow-hidden rounded-[34px] px-5 py-7 text-center sm:px-8 sm:py-9"
            >
      ...
      <div className="composer-dock pointer-events-none relative px-3 pt-2 pb-[max(env(safe-area-inset-bottom),0.85rem)] sm:px-4 sm:pb-4">
        <AnimatePresence>
          {!empty && !atBottom && (
            <motion.button
